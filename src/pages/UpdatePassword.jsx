...
const UpdatePassword = () => {
  ...
  return (
    <div className="grid min-h-[calc(100vh-3.5rem)] bg-richblack-900 place-items-center">
        ...
        <div className="max-w-[500px] p-4 lg:p-8">
          ...
          <form onSubmit={handleOnSubmit}>
            <label className='relative'>
              ...
              <input required type={showPassword ? "text" : "password"} name='password' placeholder='Enter Password' value={password} onChange={handleOnChange} className="form-style w-full !pr-10" />         
            ...
            <label className='relative block mt-3'>
              ...
              <input required type={showConfirmPassword ? "text" : "password"} name='confirmPassword' placeholder='Confirm Password' value={confirmPassword} onChange={handleOnChange} className='form-style w-full !pr-10' />         
