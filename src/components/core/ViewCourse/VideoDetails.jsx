...
const VideoDetails = () => {
    ...
    ; (async () => {
      ...
      if(courseSectionData.length) {
       ...
       if(filteredVideoData){
        ...
        setPreviewSource(courseEntireData?.courseDetails?.thumbnail)
        setVideoEnded(false)
  ...
  const goToNextVideo = () => {
    ...
    if (currentSubSectionIdx !== noOfSubsections - 1) {
      const nextSubSectionId = courseSectionData[currentSectionIdx].subSection[currentSubSectionIdx + 1]._id
